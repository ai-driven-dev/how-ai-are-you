...
const directory = existsSync(FILE)
  ...
  : { event: 'how-ai-are-you', updated_at: null, count: 0, participants: [] }
...
if (action === 'inscription') {
  ...
  directory.participants.push({
    ...
    linkedin: cleanLinkedIn(f['Votre LinkedIn']),
    tools: f['Vos outils'] ?? null,
    piste: f['La piste que vous comptez explorer'] ?? null,
