...
[![S'inscrire](https://img.shields.io/badge/⚔️_S'INSCRIRE-4e4ef9?style=for-the-badge&logoColor=white)](https://github.com/ai-driven-dev/how-ai-are-you/issues/new?template=inscription.yml)
...
```mermaid
flowchart LR
    A["✍️ Tu t'inscris"] --> B["🗓 Vendredi 14h<br/>tout est publié ici"]
    B --> C["🔨 Tout le week-end<br/>tu construis, à ton rythme"]
    C --> D["🚀 Lundi 12h<br/>tu rends"]
    D --> E["🏆 Mardi 12h<br/>résultats"]
```
...
<sub>Organisé par <a href="https://www.ai-driven-dev.fr/">AI-Driven Dev</a> · Contenu sous licence <a href="./LICENSE">MIT</a></sub>
